    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="https://www.freeiconspng.com/uploads/real-madrid-logo-png-1.png" class="img-fluid" width="300" />
          <div>
...
<!-- article end -->
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://cdn.antaranews.com/cache/1200x800/2024/06/02/2024-06-01T212427Z_456917620_UP1EK611N7UQC_RTRMADP_3_SOCCER-CHAMPIONS-DOR-MAD-REPORT.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://cdn.antaranews.com/cache/1200x800/2024/11/25/1000006149_1.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://cdn.antaranews.com/cache/1200x800/2024/05/05/000_34QV9YQ_1.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://publish-p47754-e237306.adobeaemcloud.com/adobe/dynamicmedia/deliver/dm-aid--d46b9142-52e0-4ae6-8232-932be7cfbf8e/Img_3_Background_1920x1080_Desktop.app.jpg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://cdn.antaranews.com/cache/1200x800/2018/04/ronaldo.jpg"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.14919</h3>
            <h1 class="fw-bold">Harits Martsyabel Ristyan Jessy</h1>
    ...
    <footer id="footer" class="text-center p-5">
      ...
      <div>Harits Martsyabel Ristyan Jessy &copy; 2023</div>
    </footer>
    <!-- footer end -->
